<script setup lang="ts">
	import { ElAvatar, ElDialog, ElInput, ElMessage } from "element-plus";
	import { SwitchButton, Lock } from "@element-plus/icons-vue";
	import { appInstance } from "@/main";
	import { useUserStore } from "@/store/user.ts"; // 请根据实际路径调整
		...
		<div class="flex flex-col gap-4px">
			<div class="flex flex-justify-between flex-items-center">
				<div class="font-size-16px font-weight-bold">
					{{ realName }} <ElTag>{{ appInstance._config.workId }}</ElTag>
				</div>
				<div>
