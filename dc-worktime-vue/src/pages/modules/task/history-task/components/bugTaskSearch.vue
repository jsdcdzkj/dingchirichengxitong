		...
		<ElRow :gutter="16">
			...
			<ElCol :span="5">
				<ElFormItem label="严重程度">
					<ElSelect v-model="form.priority" placeholder="请选择严重程度" clearable filterable>
						<ElOption label="轻微" value="1"></ElOption>
						<ElOption label="一般" value="2"></ElOption>
						<ElOption label="严重" value="3"></ElOption>
					</ElSelect>
				</ElFormItem>
			</ElCol>
			<ElCol :span="5">
