<template>
	<div class="flex" style="min-height: 200px; width: 100%">
		<div class="flex" v-if="detail.completionHistoryList && detail.completionHistoryList.length > 0">
			<div class="left">
				<div
					class="item"
					:class="{ active: activeIndex == index }"
					v-for="(item, index) in detail.completionHistoryList"
					:key="index"
...
<script setup lang="ts">
	...
	const noRsolveInfo = ref(props.detail.completionHistoryList?.[0]);
