...
//				s.startsWith("SqlSession") ||
//				s.startsWith("Releasing transactional") ||
//				s.startsWith("Fetched SqlSession") ||
//				s.startsWith("Registering transaction") ||
//				s.startsWith("Transaction") ||
//				s.startsWith("Cache") || s.startsWith("JDBC") || s.startsWith("Closing")) {
//			return;
//		}
